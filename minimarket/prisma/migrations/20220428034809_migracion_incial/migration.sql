...
-- CreateIndex
CREATE UNIQUE INDEX "detalles_pedidos_id_key" ON "detalles_pedidos"("id");
...
-- AddForeignKey
ALTER TABLE "detalles_pedidos" ADD CONSTRAINT "detalles_pedidos_pedido_id_fkey" FOREIGN KEY ("pedido_id") REFERENCES "pedidos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
