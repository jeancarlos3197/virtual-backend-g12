...
class Usuario(conexion.Model):
    ...
    def encriptar_pwd(self):
        # primero el password lo convierto en bytes
        password_bytes = bytes(self.password, 'utf-8')
        # usamos el metodo gensalt para generar un hash aleatorio y este se combinara con mi contraseña para generar un nuevo hash que ese será el que guardaremos en la bd
        ...
        # sobree escribo el valor del password en la instancia por el generado
